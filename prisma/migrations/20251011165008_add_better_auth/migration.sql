...
*/
-- DropForeignKey
ALTER TABLE "public"."BusinessCustomer" DROP CONSTRAINT "BusinessCustomer_userId_fkey";

-- DropForeignKey
ALTER TABLE "public"."BusinessMember" DROP CONSTRAINT "BusinessMember_userId_fkey";
